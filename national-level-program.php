...
<div id="body">
   ...
   <div class="full_width  sorting_panel  col-md-12 col-sm-12" style="background: #f6f4f4 ; ">
         ...
         <div class="rightCol " style="margin-top:24px; float:right;">
            <div class="program col-md-8 col-sm-8" style="float: left; width:100%; margin-top: 2%">
               <span style="font-size:130%; margin-left:-15%; padding:14px; width:100%;"><i class="fa fa-square nationals"  aria-hidden="true"></i>National Program by National Office</span>
         ...
         <ul class="participateListing">
            <?php
              ...
              <li id="programLists<?php echo $programmeListCount;?>">
                       ...
                       <h4><a href="#"><?php echo $objBase->sub_str($row->adp_name,100)?></a></h4>
                         ...
                         <!-- desc icons End-->
                          <ul class="sort_place_icons">
                                       <li><div style="float:left;width:10%"><i class="fa fa-location-arrow listreporticon"  aria-hidden="true"></i></div>
                                         <div style="float:left; width:90%;padding-top:1%;"> <span class="starting_text" ><?php echo $row->adp_report_point ?> - <?php echo $objProgramme->showProgramDuration($row->adp_duration, $row->adp_from_date, $row->adp_to_date); ?>
                                          </span></div>
                                       </li>
                                       <li>
                                       <div style="float:left; width:10%"> <i class="fa fa-calendar listreporticon" aria-hidden="true"></i>
                                       </div> 
                                         <div style="float:left; width:90%;padding-top:1%;"> <span class="time_date"><span ><?php echo $row->adp_period ?> </span>
                                          </span>
                                          </div>
                                       </li>
                                       <li><div style="float:left;width:10%;"><i class="fa fa-briefcase listreporticon" aria-hidden="true"></i>       </div>             
                                         <div style="float:left; width:90%;padding-top:1%;"> <span class="includes_text" ><?php echo $row->adp_cover_services ?>
                                          </span>
                                          </div>
                                       </li>
                                       <li><div style="float:left; width:10%;"><i class="fa fa-inr listreporticon" aria-hidden="true" ></i></div>
                                       <div style="float:left; width:90%;padding-top:1%;"> <span><?php echo $row->adp_price ?></span></div>
                                       </li>
                                    </ul>
