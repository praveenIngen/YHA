            ...
            if ($age < 18 && $data['plan_code'] != 'J1') {
                ...
                if (($age < 11 or $age > 18) and $data['plan_code'] == 'J1') {
                    ...
                    if ($err == "") {
                        ...
                        $objBase->Redirect('individual-memberships-confirmation.php');
...
<script type="text/javascript">
     /*images upload js starts*/
       function SetName() {
              var  photographID ="";
              var photo ="";
              alert(photographID , photo, "hellpooooo");
              var photographID = document.getElementById("photographupload").value; 
              alert(photographID , "fullll");
              if(photographID != null ){
                alert(photographID, "ifcase" );
              var photo = photographID;
              alert(photo);
              $('#photograph').val(photographID);
              alert("#photograph");
               $('.dialogBox').modal('hide');
             
              }
        //this.document.getElementById("photograph").value== $.(photographID.value);
}
...
/*    
         function GetImages(id) {
            this.id = id;
            var i = document.getElementById("photographupload").src;
            var j = new Image();
            j.src = i;
...
<!-- <script type="text/javascript" src="<?php echo SITE_PATH_WEBROOT ?>/jquery.min.js"></script> 
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script> -->
<!-- <script  type="text/javascript" src="<?php echo SITE_PATH_WEBROOT ?>/jquery-min.js"></script> 
<script  type="text/javascript" src="<?php echo SITE_PATH_THEME_JS ?>/bootstrap.min.js"></script> -->
<!-- <script type="text/javascript">
