...
$membership_options = $OBJ_MASTER_CONTROLLER->GetMemberShipType($data['MEMBERSHIP_TYPE']);


$membership_prices = $objMembers->list_membership_prices('Individual');


$State_options = $OBJ_MASTER_CONTROLLER->GetState($data['StateID']);
                        ...
                        <!--  package_booking_form start -->
                            <div class="col-lg-12 col-md-12">
                                <div class="col-lg-6 col-md-6 form-group">
                                    ...
                                    <select name="MEMBERSHIP_TYPE" id="MEMBERSHIP_TYPE" class="form-control" onchange="load_membership_fee(this.value);">
                            ...
                            <div class="col-lg-12 col-md-12">
                                ...
                                <div class="col-lg-6 col-md-6 form-group">
                                    ...
                                    <input type="text" name="FirstName" id="FirstName" value="<?php echo $data['FirstName']; ?>" class="form-control" maxlength="25" />
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12">
                                <div class="col-lg-6 col-md-6 form-group">
