...
$city_options = $OBJ_MASTER_CONTROLLER->GetCities($data['abk_city'], $data['abk_state'], false);*/
 ...
 <script type="text/javascript">
  jQuery(function () {
    ...
    $(":file").filestyle({classInput: "input-small"});
        ...
        jQuery.getJSON("Programselect_city_ajax.php", {id: jQuery(this).val()}, function (res_data) {
