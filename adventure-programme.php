         ...
         <div class="col-md-12 col-sm-12">
          ...
          <?php } ?>
            <div class="buttonDiv travel_form_element  pull_left responsebtn col-md-2 col-sm-2" style="margin-top: 1%;">
               <button class="btn btn-yellow buttonStyle btn-travel  first tab1 programtabBtn active" type="button" toShow = "content1"  ><a href="#content1" style="color: #ffffff;">About Us</a></button>
            </div>
            <div class="buttonDiv travel_form_element  pull_left responsebtn col-md-2 col-sm-2" style="margin-top: 1%;">
               <button class="btn btn-yellow  buttonStyle btn-travel  tab2 programtabBtn"  type="button"  toShow = "content2"   ><a href="#content2" style="color: #ffffff;"> Participation</a></button>
            </div>
            <div class="buttonDiv travel_form_element tabcontent pull_left responsebtn col-md-2 col-sm-2" style="margin-top: 1%;">
               <button class="btn btn-yellow btn-travel buttonStyle tab4 programtabBtn" type="button"  toShow = "content3" ><a href="#content3" style="color: #ffffff;">Facts</a></button>
            </div>
            <div class="buttonDiv travel_form_element  pull_left responsebtn col-md-2 col-sm-2" style="margin-top: 1%;">
               <button class="btn btn-yellow btn-travel buttonStyle  tab4 programtabBtn"  type="button"  toShow = "content4"  ><a href="#content4" style="color: #ffffff;">Directions</a></button>
            </div>
          <div class="buttonDiv travel_form_element  pull_left responsebtn col-md-2 col-sm-2" style="margin-top: 1%;">
               <button class="btn btn-yellow buttonStyle btn-travel tab5 programtabBtn"   type="button"  toShow = "gallery" ><a href="#gallery" style="color: #ffffff;">Gallery</a></button>
            </div>
            <?php if ($prog->adp_brochure_file == "") { ?>
          <div class="col-md-1 col-sm-1"></div>
          <?php } ?>
               ...
               <div class="buttonDiv travel_form_element  pull_left responsebtn col-md-2 col-sm-2" style="margin-top: 1%;">
               <?php if ($prog->adp_brochure_file != "") { ?>
           <a class="buttonStyle" href="<?php echo SITE_URL ?>uploads/programme/brochure/<?php echo $prog->adp_brochure_file; ?>" style="color: #ffffff;">    <button class="btn btn-yellow btn-travel buttonStyle tab6 programtabBtn"   type="button"   style=" font-size: 19px; font-weight: bold;">Brochure</button></a>
                <?php } ?>
            </div>
                     ...
                     <div class="col-md-12 col-sm-12">
                        <div class="col-md-9 col-sm-9 margnlft1">
                           <ul>
                              ...
                              <li class="listalign"><i class="fa fa-briefcase listreporticon" aria-hidden="true"></i>                    
                                 <span class="includes_text" style="color:black;"><?php echo $prog->adp_cover_services ?>
                                 </span>
                              </li>
                           </ul>
                        </div>
                        <div class="right_includes_hotel responsecheckin1 col-md-3 col-sm-3 " style="float: right; margin-right: -3%;">
                           <?php 
                              ...
                              ?>
                           <div class="check_in_out_wrap paddingleft" style="padding-left:35%;">
         ...
         <div class="pcg_tabs_pane">
            <div class="tabContentBottom" style="padding:2%;">
               ...
               <div class="tabContentNew">
                  ...
                  <div id="gallery" class="galleryBlock tabcontent programtabContent ">
            ...
            <a name="gal" id="gal"></a>
                ...
                <?php if ($proGal) { ?>
                  <div class="container">
                   <div class="galleryBlock" ><!-- GALLERY BLOCK start -->
