...
/*include_once("common/coreAPI/serviceManager.php");*/
...
if ($data) {
 /*pre(  $_SESSION['member_register']);
   ...
   /*   $plan_amount = $objMembers->get_membership_plan_amount($_SESSION['member_register']['MEMBERSHIP_TYPE']);*/
       /*  $_SESSION['member_register']['Charges'] = $Charges; 

        $_SESSION['member_register']['total_amount'] = $Charges; // *inclusive Service tax
/*
...
*/
        //$_SESSION['member_register']['transaction_charges'] = 1;

        

       /* $_SESSION['member_register']['plan_breakup'] = $objMembershipPlans->get_serialized_paln_breakup($_SESSION['member_register']['MEMBERSHIP_TYPE']);*/
/*
        if($_SESSION['member_register']['city_other']!="" && $_SESSION['member_register']['CityID']=="others"){

            $_SESSION['member_register']['CityID'] = $OBJ_MASTER_CONTROLLER->GetCities($_SESSION['member_register']['CityID'], $_SESSION['member_register']['StateID'], false)  ;
          ...
          $data =  json_encode($data);
            $ApiRoute ="http://192.168.10.11:8088/API/api/mobile/members";
            pre("helloooo alert");
            $response=$MEMBERSHIP_CONTROLLER ->Post($ApiRoute,$data,false); 
            pre($response);
                               ...
                               <div class="col-md-6 col-sm-6 prognamewidth">
                                <table class="table">
                                 ...
                                 <div class="top_head_bar  col-md-6 col-sm-6" style=" float: right;">
                                   ...
                                   <img style=" float: right; height:115px;" src="<?php echo $_SESSION['member_register']['photograph']; ?>" alt=""> </a>
                                   </figure>
                                </div>
            ...
            ?>                   
                          ...
                          <form name="frm_register" id="frm_register" method="post" action="" enctype="multipart/form-data">  
                            ...
                            <div class="full_width ">
                              ...
                              <button type="submit" id="ProceedPay" style="width:100%; font-size:175%; margin-top: 2%;" value="proceed to next step" class="btn_green proceed_buttton btns">proceed to pay <i class="fa fa-inr rupeesicon" aria-hidden="true" ></i>&nbsp; <?php echo $_SESSION['member_register']['dataCharges'];?></button>
                            </div>
                            <!-- proceed button -->
                        </form>  
