   ...
   <div class="full_width  sorting_panel  col-md-12 col-sm-12" style="background: #f6f4f4 ; ">
         ...
         <div class="rightCol " style="margin-top:24px; float:right;">
            <div class="program col-md-8 col-sm-8" style="float: left; width:100%; margin-top: 2%">
               <span style="font-size:130%; margin-left:-15%; padding:14px; width:100%;"><i class="fa fa-square nationals"  aria-hidden="true"></i>National Programs by State Branch</span>
