...
if(isset($data)){
 ...
 /*
    ...
    $response['ResponseMessage'] = Enum::HttpStatus()->OK;*/

   
     // $MembershipDetail = $MEMBERSHIP_REPOSITORY->Get($response['MerchantRefNo']);
  //pre($MembershipDetail);
  //pre($MembershipDetail->ServicePayload->MemberId);
  //pre($response['MerchantRefNo']);
  //die;
    ...
    if (is_array($response) && count($response) > 0) {
       ...
       // pre($_SESSION['transaction_response']);
        //to check canclation
...
die;*/
 ...
 $ImageUrl=$MembershipDetail->BinaryFileBasePath ;
  $ImagePath= $MembershipDetail->ServicePayload->Documents[0]->DocumentPath;
                     ...
                     <div class="tour_package_booking_section">
                        ...
                        <div id="tour_booking_tabs">
                           ...
                           <div id="indiv_member_status_info" class="main_content_area hotel_main_content">
                            ...
                            <?php echo  $objMembers->get_membership_web_message($MerchantRefNo);?>
                                      ...
                                      <th style="border-top: none;">Personal Details</th>
                                       <tr>
                                          ...
                                          <td><?php
                                             ...
                                             echo $MembershipDetail->ServicePayload->Person->FirstName;  
                                        ...
                                        <tr>
                                          <td> Date of birth :</td>
                                          <td><?php 
                             if($MembershipDetail->ServicePayload->Person->DateOfBirth != "" && !empty($MembershipDetail->ServicePayload->Person->DateOfBirth)){
                              echo date("d-m-Y",strtotime($MembershipDetail->ServicePayload->Person->DateOfBirth));
                             }
                             else{
                              echo "";
                             }
                                        ...
                                        <tr>
                                          <td>Address :</td>
                                          <td><?php echo $MembershipDetail->ServicePayload->Person->PersonAddress->AddressLineOne; ?></td>
                                        </tr>
                                        <tr>
                                          <td>City :</td>
                                          <td><?php echo $MembershipDetail->ServicePayload->CityName; ?></td>
                                        </tr><tr>
                                          <td>State :</td>
                                          <td><?php echo $MembershipDetail->ServicePayload->StateName; ?></td>
                                        </tr>
                                        <tr>
                                   ...
                                   <img style=" float: right; height:85px;" src="<?php echo  $ImageUrl.$ImagePath; ?>" alt=""> </a>
                                   </figure>
                                </div>  
                                     <table class="table">
                                    <th style="border-top: none;" >Membership Details</th>
                                       <tr>
                                        ...
                                        <tr>
                                          ...
                                          <td><?php echo $MembershipDetail->ServicePayload->MembershipCode; ?></td>
                                        </tr>
                                       
                                        <tr>
                                          <td> Membership Validity</td>
                                          <td><?php 
                                          if($MembershipDetail->ServicePayload->MembershipTypeName== "Lifetime") {
                                            echo ("LIFETIME");
                                          }
                                          else{
                                          echo date("d-m-Y",strtotime($MembershipDetail->ServicePayload->ExpiryDate));
                                        }
                                           ?> 
                                          </td>
                                        </tr>
